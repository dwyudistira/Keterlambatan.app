...
@section('content')
<form action="{{ route('late.update' , $lates['id']) }}" method="post" class="card p-5" enctype="multipart/form-data" style="margin-top: 90px">
    @csrf
    @method('PATCH')
    ...
    @endif
    <div class="mb-3 row">
      <label for="student" class="col-sm-2 col-form-label">Nama Siswa :</label>
      <div class="col-sm-10">
    ...
    <div class="mb-3 row">
      ...
      <div class="col-sm-10">
        ...
        <textarea class="form-control" id="information" name="information" rows="3">{{ $lates['information'] }}</textarea>
      </div>
    </div>
    <div class="mb-3 row">
      ...
      <img src="{{ Storage::url('public/bukti_keterlambatan/' . $lates->bukti) }}" alt="">
    </div>
